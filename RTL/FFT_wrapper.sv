...
module fft_16pt_top #(
    ...
    function automatic signed [15:0] round_shift1(input signed [15:0] val);
        ...
        begin
            biased  = {val[15], val} + 17'sd1;   // sign-extend to 17b, add half-ULP bias
            shifted = biased >>> 1;
            if (shifted > 17'sd32767)
                round_shift1 = 16'sd32767;
            else if (shifted < -17'sd32768)
                round_shift1 = -16'sd32768;
            else
                round_shift1 = shifted[15:0];
        end
    endfunction
